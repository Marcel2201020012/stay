...
import masukimg from '../images/masuk.png';
     ...
     <style>
      ...
      <div
        className="hidden lg:flex lg:w-1/2 bg-cover bg-center relative"
         style={{
          backgroundImage: `url(${masukimg})`,
          backgroundSize:'cover',
          backgroundPosition: 'center',
          backgroundRepeat: 'no-repeat', }}>
        <div className="absolute inset-0 bg-black opacity-60"></div>
        <div className="relative z-10 flex flex-col justify-center items-start pl-10 pr-8 py-8 text-white" style={{ fontFamily: 'Inter, sans-serif' }}>
          <p className="text-4xl lg:text-5xl font-normal mb-4 leading-snug" style={{ fontFamily: 'Inter, sans-serif' }}>
          Bingung Nginap
          </p>
          <p className="text-4xl lg:text-5xl font-normal mb-4 leading-snug" style={{ fontFamily: 'Inter, sans-serif' }}>
          Dimana?
          </p>
          <h1 className="text-4xl lg:text-5xl font-extrabold mb-4 leading-snug" style={{ fontFamily: 'Inter, sans-serif' }}>
           Stay With Us Aja!
          </h1>
        </div>
      </div>
